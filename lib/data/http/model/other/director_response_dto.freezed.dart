...
part of 'director_response_dto.dart';
...
class _$_Director implements _Director {
  const _$_Director({required this.id, required this.fullName});
...
abstract class _Director implements Director {
  const factory _Director(
      {required final int id, required final String fullName}) = _$_Director;
